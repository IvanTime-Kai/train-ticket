...
const file_train_proto_rawDesc = "" +
	"\n" +
	"\vtrain.proto\x12\x05train\"p\n" +
	"\bSeatInfo\x12\x17\n" +
	...
	"\fTrainService\x12J\n" +
	"\rValidateSeats\x12\x1b.train.ValidateSeatsRequest\x1a\x1c.train.ValidateSeatsResponseB4Z2github.com/leminhthai/train-ticket/proto/gen/trainb\x06proto3"

var (
	file_train_proto_rawDescOnce sync.Once
	file_train_proto_rawDescData []byte
)

func file_train_proto_rawDescGZIP() []byte {
	file_train_proto_rawDescOnce.Do(func() {
		file_train_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_train_proto_rawDesc), len(file_train_proto_rawDesc)))
	})
...
func file_train_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_train_proto_rawDesc), len(file_train_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
